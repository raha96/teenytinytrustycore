...
# Hardware Root of Trust - Crypto Operations Test

echo "======================================================="
echo "  Hardware Root of Trust - Crypto Operations Test"
echo "  Tests: SHA-256, HMAC-SHA-256, AES-CTR"
echo "======================================================="
